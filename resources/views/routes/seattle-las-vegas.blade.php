...
<head>
  ...
  <meta name="keywords" content="seattle-las-vegas">
  <title>tripdear.com |seattle-las-vegas </title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-12 text-center">
          <h1 class="text-white">Cheap flight from Seattle to Las Vegas</h1>
        </div>
      </div><!--/row-->
			...
			<div class="row">
				...
				<div class="row">
					...
					<div class="row">
						...
						<input class="form-control custom-form rounded-0" type="text" placeholder="Origin" name="origin" id="origin" value="SEA" autocomplete="off" required >
                ...
                <div class="col-12 col-md-12">
                  <table class="table table-bordered">
                    <tbody>
                      ...
                      <tr>
                        <td>Airport</td>
                        <td>Mc Carran International Airport (LAS)
